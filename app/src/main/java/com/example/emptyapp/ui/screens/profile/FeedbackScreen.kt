...
import com.example.emptyapp.data.FeedbackStore
...
fun FeedbackScreen(onBack: () -> Unit = {}) {
    ...
    if (submitted) {
        // G5-134: Confirmation state shown after Firestore write completes
        ...
        FeedbackFormContent(
            ...
            onSubmit = {
                ...
                FeedbackStore.save(
                    ...
                    // On network error the write is queued by Firestore offline cache;
                    // we still show the confirmation so the UX isn't stuck.
...
private fun FeedbackFormContent(
    ...
    // Submit is only enabled when the message is not blank and not already in flight.
